package com.pranjal98.grosseryshopnearme;
        ...
        switch(v.getId())
        {
            case R.id.B_search:
                ...
                if(!location.equals(""))
                {
                    ...
                    try {
                        ...
                        if(addressList != null)
                        {
                            for(int i = 0;i<addressList.size();i++)
                            {
                                ...
                                String url = getUrl(addressList.get(i).getLatitude(), addressList.get(i).getLongitude(), grocery_or_supermarket);
                                dataTransfer[0] = mMap;
                                dataTransfer[1] = url;
                    ...
                    Toast.makeText(MapsActivity.this, "Showing Nearby Grocery Shops", Toast.LENGTH_SHORT).show();
                    tf_location.setText("");
                }
                else{
